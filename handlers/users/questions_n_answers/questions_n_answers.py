...
async def questions_n_answers(callback: types.CallbackQuery, state: FSMContext) -> None:
    ...
    # Set questions_n_answers_picker state.
    await QuestionsAndAnswersPickerStatesGroup.questions_n_answers_picker.set()
