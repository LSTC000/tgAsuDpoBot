...
from data.callbacks import CANCEL_TO_QUESTIONS_N_ANSWERS_CALLBACK_DATA
...
@dp.callback_query_handler(
    lambda c: c.data == CANCEL_TO_QUESTIONS_N_ANSWERS_CALLBACK_DATA,
    state=QuestionsAndAnswersPickerStatesGroup.question_n_answer_report
)
async def cancel_to_questions_n_answers(callback: types.CallbackQuery, state: FSMContext) -> None:
